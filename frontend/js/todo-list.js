...
'<div id="todo-list-container-{todo_list_id}" class="col-lg-4">' +
    '<div class="card px-3">' +
        '<div class="card-body">' +
...
'<li class="{todo_list_task_completed}">' +
    '<div class="form-check">' +
        '<div class="form-check-label">' +
            '<input onclick="toggleTaskChecked(\'{todo_list_id}\', \'{todo_list_task_id}\', {todo_list_task_is_checked})" class="checkbox" type="checkbox" {todo_list_task_checked}>' +
            '<p onclick="editTask(\'{todo_list_id}\', \'{todo_list_task_id}\', \'{todo_list_task}\')">{todo_list_task} <i class="fa fa-pencil"></i></p>' +
        '</div>' +
    '</div>' +
'</li>';